...
var Overview=React.createClass({displayName: "Overview",
  ...
  render: function() {
    ...
    React.createElement("span", {className: "counter"}, res.length), 
